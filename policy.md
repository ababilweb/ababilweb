...
Welcome to the Ababil Browser app for Android!

This is an open source Android app developed by Ababil Solution. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
